...
| `20260921000000_night_program`            | AuditKind +11 değer (dosya başında; aynı dosyada kullanılmaz), PublicScan visitorHash/tenantId/sector/meta/partial/views + 3 indeks, Lead, BlockedSite, Announcement, AgencySignal + enum'lar, PublicScan → Lead backfill | additive (DROP yok)           |
