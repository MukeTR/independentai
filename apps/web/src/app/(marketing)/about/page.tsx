      ...
      <Section id="mission" eyebrow="Misyon">
        <div className="max-w-3xl text-[17px] text-ink leading-[1.7] space-y-6">
          <p>
            ...
            paradigma çatlıyor: milyonlarca kullanıcı artık Google'a değil, ChatGPT'ye, Claude'a, Gemini'ye soruyor. AI
            cevaplarında ilk 3'te değilseniz, bir Google sonucunun 5.sayfasında olmaktan beterdir — tıklayacak link bile
            yoktur.
          </p>
          <p>
          ...
          <p>
            ...
            filtrelemiyoruz, sıralamayı bozmuyoruz. Olduğu gibi gösteriyoruz — siz ne yapacağınıza karar veriyorsunuz.
          </p>
        </div>
      </Section>
      ...
      <Section id="why-now" eyebrow="Neden şimdi" title="2026 GEO'nun dönüm noktası." className="bg-paper-2/40">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {[
            ...
            {
              y: '2024',
              t: 'Yapısal değişim başlıyor',
              d: "Gartner: \"2026'da arama trafiğinin %25'i geleneksel motorlardan AI'ya kayacak.\"",
            },
            {
              y: '2026',
              t: 'Standartlaşma',
              d: 'GEO bir disiplin olarak yerleşiyor. llms.txt standartı ortaya çıkıyor. Markalar ölçüm aracı arıyor.',
            },
          ].map((m) => (
      ...
      <Section id="principles" eyebrow="İlkeler" title="Hangi prensiplerle çalışıyoruz?">
        <div className="space-y-6">
          {[
            {
              t: 'Bağımsızlık',
              d: 'Hiçbir AI provider ile iş ortaklığımız, gelir paylaşımımız veya teşvikimiz yok. Sonuçlar ham veridir.',
            },
            {
              t: 'Şeffaflık',
              d: 'Ölçüm metodolojimiz dokümante, kod açık (planlanan). Sayıların nereden geldiği gizli değil.',
            },
            {
              t: 'Türkçe öncelik',
              d: 'Türkiye pazarına özel. Türkçe ek yapıları, marka isimleri, rakip dinamikleri için optimize.',
            },
            {
            ...
            {
              t: 'Veri sahipliği',
              d: "Verileriniz size ait. Export edilebilir, silinebilir. AI provider'lara prompt dışı veri gönderilmez.",
            },
          ].map((p) => (
