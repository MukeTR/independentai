...
export const metadata = buildMetadata({
  ...
  description:
    '12 sayfalık başucu rehberi. GEO nedir, neden önemli, ne yapmalı? Türkiye pazarına uyarlı pratik rehber.',
      ...
      <section className="pt-20 pb-12">
        <Container className="max-w-4xl">
          ...
          <p className="text-[17px] text-ink-muted mt-6 leading-relaxed">
            ...
            isteyen markalar için 90 günlük başlangıç planına kadar her şey.
          </p>
        </Container>
      </section>
      ...
      <article className="pb-20">
        <Container className="max-w-3xl">
          <Chapter id="intro" n="01" t="Giriş: SEO'dan GEO'ya">
            <p>
              1999\'da Google geldi. 25 yıl boyunca markanın online görünürlüğü "Google\'da sıralama" ile özdeşleşti.
              Backlink, içerik, teknik SEO — hepsi tek bir hedef için: arama sonuçlarında üst sıralarda yer almak.
            </p>
            <p>
              2022\'de ChatGPT lansmanı oldu. 5 günde 1 milyon, 2 ayda 100 milyon kullanıcı. 2025\'te kullanıcılar "en
              iyi …" sorularını AI\'ya sormaya başladı. 2026\'da bu davranış mainstream oldu.
            </p>
            <p>
          ...
          <Chapter id="why" n="02" t="Neden 2026'dan itibaren GEO kritik?">
            <p>
              Üç sayı: (1) ChatGPT Türkiye\'de 8M aktif kullanıcı. (2) Bunların %43\'ü satın alma kararında AI
              önerisinden etkilendi. (3) "En iyi …" sorularında AI 2-3 marka öneriyor — daha fazlasını değil.
            </p>
            <p>
          ...
          <Chapter id="measurement" n="04" t="GEO'da ölçüm nasıl yapılır?">
            <p>
              SEO\'da Google Search Console, Ahrefs, SEMrush gibi araçlar olgun. GEO\'da henüz benzer olgunluk yok. Şu
              üç metriği temel alın:
            </p>
            <ul>
              <li>
                <strong>Görünürlük Skoru:</strong> İzlenen sorgularda markanızın geçtiği oran (0-100%).
              </li>
              <li>
          ...
          <Chapter id="kpis" n="09" t="GEO'da hangi KPI'lara bakılır?">
            <ul>
              <li>
                <strong>Aylık Görünürlük Skoru hedefi</strong> (örn. 60%\'dan başla, 80%\'e çek)
              </li>
              <li>
          ...
          <Chapter id="future" n="12" t="Geleceğe bakış: 2027 ve sonrası">
            <p>
              2027\'de AI modelleri muhtemelen kendi içlerinde "premium öneri" mekanizması açacak (Google\'daki ads
              gibi). Bu olmadan önce organik görünürlüğünüzü maksimuma çıkarmak hayati.
            </p>
            <p>
