...
export default function AdminError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="card p-8 text-center max-w-lg mx-auto mt-10" role="alert">
      ...
      <h2 className="font-display text-[22px] mt-2">Ekran yüklenemedi</h2>
      <p className="text-[14px] text-ink-muted mt-2">
        Veri okunurken beklenmeyen bir hata oluştu. Tekrar deneyin; sürerse Sistem ekranındaki sağlık kutusuna ve sunucu
        loglarına bakın.
      </p>
      ...
      <div className="flex justify-center gap-2 mt-6">
        ...
        <Link href="/admin" className="btn-secondary !py-2 !px-4 text-[13px]">
          Genel bakışa dön
        </Link>
      </div>
    </div>
