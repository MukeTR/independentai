...
export const metadata = { title: 'Ajans ekibi — Yanıt' };
  ...
  return (
    <div>
      ...
      <p className="text-[14px] text-ink-muted mt-2 mb-6 max-w-2xl">
        ...
        yazabilir; Analist yalnızca görür. Başlangıç planında {ent.limits.seats} koltuk ve {ent.limits.clients} müşteri.
      </p>
      <AgencyTeamManager />
    </div>
  );
