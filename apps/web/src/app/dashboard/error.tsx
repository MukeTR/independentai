  ...
  return (
    <div className="card p-8 text-center max-w-lg mx-auto mt-10" role="alert">
      ...
      <p className="text-[14px] text-ink-muted mt-2">
        Sayfa yüklenirken beklenmeyen bir hata oluştu. Tekrar deneyebilir veya panele dönebilirsiniz.
      </p>
      ...
      <div className="flex justify-center gap-2 mt-6">
        ...
        <Link href="/dashboard" className="btn-secondary !py-2 !px-4 text-[13px]">
          Panele dön
        </Link>
      </div>
    </div>
