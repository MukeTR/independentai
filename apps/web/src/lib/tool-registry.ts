...
export const TOOL_REGISTRY: ToolEntry[] = [
  ...
  {
    slug: 'satin-alma-sorusu-kapsama',
    kind: 'QUESTION_COVERAGE',
    title: 'Satın alma sorusu kapsama',
    question: 'Müşterinizin sorduğu sorulara sitenizde cevap var mı?',
    shortTitle: 'Satın alma soruları',
    description: 'Sektörünüzün 25 satın alma sorusu; FAQ/soru başlığı kapsaması ve fiyat/konum sinyali.',
    group: 'ai-gorunurluk',
    endpoint: '/api/tools/satin-alma-sorusu-kapsama',
    budgetRequests: 32,
    dashboard: true,
    icon: 'HelpCircle',
    enabled: false,
